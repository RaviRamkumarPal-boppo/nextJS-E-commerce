          ...
          <div className="flex justify-between sm:justify-evenly py-4 ">
              ...
              <ul className="list-none flex">
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className={`px-2 lg:px-4 py-2 hover:bg-[#2f757c] ${
            ...
            <div>
              <ul className="flex ">
                ...
                <li
                  className={`p-2 text-lg relative hover:bg-[#2f757c] ${
                    pathname === postLink[0].href ? "active-Link" : ""
                  }`}
                >
                  <Link href="/wishlist">
                    <GoHeart />
                ...
                <li
                  className={`p-2 text-lg relative hover:bg-[#2f757c] ${
                    pathname === postLink[1].href ? "active-Link" : ""
                  }`}
                >
                  <Link href="/carts">
                    <IoBagHandleOutline />
                ...
                <li
                  className={`p-2 text-lg relative hover:bg-[#2f757c] ${
                    pathname === postLink[2].href ? "active-Link" : ""
                  }`}
                >
                  <Link href="/profile">
                    <CgProfile />
                ...
                {navLinks.map((link) => (
                  <li key={link.href} className="p-2">
                    <Link
                      href={link.href}
                      className={`p-2 ${
                        pathname === link.href ? "mobile-active-Link" : ""
                      }`}
                    >
                      {link.label}
                    </Link>
      ...
      <div className="mt-5">
            ...
            <div className="flex justify-center lg:justify-end items-center px-3">
              <div className="w-full sm:w-9/12">
                <div className="flex justify-center sm:justify-start">
                  <span className="bg-[#426367] tracking-widest p-2 rounded-full px-3 animate-pulse">
                    FURNITURE DESIGNS IDEAS
                  </span>
                </div>
                <div className="mt-4 mb-5 sm:mb-10 flex justify-center">
                  <p className="text-[38px] sm:text-[67px] font-medium sm:leading-[77px]">
                ...
                <div>
                  <p className="text-lg">
                    ...
                    elegance and functionality to your interior while also being
            ...
            <div className="sm:flex p-2 gap-4 header-section-image">
              <div className="w-full sm:w-[400px] h-[20rem] lg:h-[35rem] lg:mb-[90px] relative header-image-1">
                ...
                <div className="absolute bottom-0 w-full h-[100px] flex flex-row justify-between items-center p-6 z-10">
                  ...
                  <p className="text-2xl text-white flex items-center">
                    1200+&#160;<span className="text-lg">items</span>
                  </p>
                </div>
              </div>
              <div className="w-full sm:w-[150px] h-[20rem] lg:h-[35rem] relative header-image-2">
                ...
                <div className="absolute bottom-0 w-full h-[200px] flex items-center justify-center z-10">
                  <p className="text-2xl text-white lg:rotate-[-90deg] whitespace-nowrap">
                    Living Room
                  </p>
                </div>
              </div>
        ...
        {pathname !== "/" && (
          <div className="flex justify-center items-center h-52">
            <p className="text-3xl font-medium">{pathname}</p>
          </div>
        )}
      </div>
    </div>
