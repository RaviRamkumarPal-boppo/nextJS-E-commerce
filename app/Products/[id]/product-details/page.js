...
function ProductDetails({ params }) {
  ...
  useEffect(() => {
    const productData = ProductsPageObj?.ProductsPageObj.find(
      (item) => item.title === params.id
    );
        ...
        <div className="col-span-1">
          ...
          <div className="rounded-3xl bg-[#f5f5f5] p-2 flex justify-between items-center gap-4 w-28">
            <button
              ...
              onClick={() => decreaseQuantity(productDetail.title)}
            >
              <FiMinus />
            </button>
            <p>{defaultQuantity}</p>
            <button
              className="rounded-full bg-white p-1"
              onClick={() => increaseQuantity(productDetail.title)}
            >
              <FiPlus />
            </button>
          </div>
          <div className="my-5 flex gap-6">
            ...
            <div
              ...
              onClick={() => handleToggleWishlist(productDetail.title)}
            >
